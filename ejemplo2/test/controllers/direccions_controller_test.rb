...
class DireccionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create direccion" do
    assert_difference('Direccion.count') do
      post direccions_url, params: { direccion: { calle: @direccion.calle, ciudad: @direccion.ciudad, estado: @direccion.estado, usuario_id: @direccion.usuario_id } }
    end
  ...
  test "should update direccion" do
    patch direccion_url(@direccion), params: { direccion: { calle: @direccion.calle, ciudad: @direccion.ciudad, estado: @direccion.estado, usuario_id: @direccion.usuario_id } }
